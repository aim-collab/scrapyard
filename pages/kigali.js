  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {Object.entries({
            ...
            'What if I have more questions?': (
              <>
                {/* TODO: Change #Scrapyard-kigali to the name of your event's Slack channel */}
                Contact us! Feel free to reach out to us in the #Scrapyard-kigali
                channel on the Hack Club slack or email us at{' '}
                {/* TODO: Change this email to your event's email */}
                <Link href=" aiman.kigali@scrapyard.hackclub.com">
                  {/* TODO: Change this email to your event's email */}
                   aiman.kigali@scrapyard.hackclub.com
                </Link>
                .
        ...
        <Link
          // TODO: Change scrapyard_Kigali to your event's slug (lowercase, dashed version of your event name), such as san-francisco for Scrapyard San Francisco
          href="https://forms.hackclub.com/scrapyard-signup?event=kigali"
          target="_blank"
        >
          <Box
